//代理Proxy  https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Proxy
...
/*无操作转发代理.代理会将所有应用到p的操作转发到target对象上。
验证.通过代理，你可以轻松地验证向一个对象的传值。这个例子使用了 set。
